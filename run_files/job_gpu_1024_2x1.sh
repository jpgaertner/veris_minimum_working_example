#!/bin/bash
#SBATCH --job-name=1024_2x1
#SBATCH --output=out_gpu/out/1024_1_2x1_20.log
#SBATCH --error=out_gpu/out/1024_1_2x1_20.err
#SBATCH --nodes=1
...
SCRIPT=run_files/run_parallel_gpu_1024_2x1.py
