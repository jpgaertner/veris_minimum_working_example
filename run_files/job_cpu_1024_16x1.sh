...
#SBATCH -p compute
#SBATCH -A bk1377
#SBATCH --job-name=1024_16x1
#SBATCH -t 0:30:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=16
#SBATCH --cpus-per-task=1
#SBATCH --output=out_cpu/out/1024_1_16x1_1000.log
#SBATCH --error=out_cpu/out/1024_1_16x1_1000.err
#SBATCH --mem=480GB
#SBATCH --exclusive
...
SCRIPT=run_files/run_parallel_cpu_1024_16x1.py
