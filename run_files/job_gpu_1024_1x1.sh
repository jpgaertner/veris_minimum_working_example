#!/bin/bash
#SBATCH --job-name=1024_1x1
#SBATCH --output=out_gpu/out/1024_1_1x1_20.log
#SBATCH --error=out_gpu/out/1024_1_1x1_20.err
#SBATCH --nodes=1
...
SCRIPT=run_files/run_parallel_gpu_1024_1x1.py
