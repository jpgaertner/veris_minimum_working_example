#!/bin/bash
#SBATCH --job-name=3072_2x1
#SBATCH --output=out_gpu/out/3072_1_2x1_100.log
#SBATCH --error=out_gpu/out/3072_1_2x1_100.err
#SBATCH --nodes=1
...
SCRIPT=run_files/run_parallel_gpu_3072_2x1.py
