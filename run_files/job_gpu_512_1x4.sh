#!/bin/bash
#SBATCH --job-name=512_1x4
#SBATCH --output=out_gpu/out/512_1_1x4_1000.log
#SBATCH --error=out_gpu/out/512_1_1x4_1000.err
#SBATCH --nodes=1
...
SCRIPT=run_files/run_parallel_gpu_512_1x4.py
