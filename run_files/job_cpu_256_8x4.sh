...
#SBATCH -p compute
#SBATCH -A bk1377
#SBATCH --job-name=256_8x4
#SBATCH -t 0:10:00
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=32
#SBATCH --cpus-per-task=1
#SBATCH --output=out_cpu/out/256_1_8x4_500.log
#SBATCH --error=out_cpu/out/256_1_8x4_500.err
#SBATCH --mem=480GB
#SBATCH --exclusive
...
SCRIPT=run_files/run_parallel_cpu_256_8x4.py
