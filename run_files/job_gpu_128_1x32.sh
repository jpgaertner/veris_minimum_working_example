#!/bin/bash
#SBATCH --job-name=128_1x32
#SBATCH --output=out_gpu/out/128_8_1x32_1000.log
#SBATCH --error=out_gpu/out/128_8_1x32_1000.err
#SBATCH --nodes=8
...
SCRIPT=run_files/run_parallel_gpu_128_1x32.py
