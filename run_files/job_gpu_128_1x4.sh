#!/bin/bash
#SBATCH --job-name=128_1x4
#SBATCH --output=out_gpu/out/128_1_1x4_1000.log
#SBATCH --error=out_gpu/out/128_1_1x4_1000.err
#SBATCH --nodes=1
...
SCRIPT=run_files/run_parallel_gpu_128_1x4.py
