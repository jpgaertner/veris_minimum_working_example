#!/bin/bash
#SBATCH --job-name=3072_1x4
#SBATCH --output=out_gpu/out/3072_1_1x4_1440.log
#SBATCH --error=out_gpu/out/3072_1_1x4_1440.err
#SBATCH --nodes=1
...
SCRIPT=run_files/run_parallel_gpu_3072_1x4.py
